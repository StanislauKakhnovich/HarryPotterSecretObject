let buttonsLanguage = [
    ...
    {
        id: '#labelFooter',
        'ru': `Игра HARRY POTTER AND THE SECRET OBJECT создана Кохновичем Станиславом, в качестве выпускного проекта по курсу JavaScript, 2022 год.`,
    ...
    {
        id: '#error8',
        'ru': `Введен неправильный e-mail или пароль.`,
        'en': `Wrong e-mail or password entered.`
    },
